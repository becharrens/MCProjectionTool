...
#             assert (
#                 len(set(tuple(action.participants) for action in actions)) == 1
#             ), "Every branch of a mixed choice should have at most one first action"
#             # assert len(actions) == 1, "Every branch of a mixed choice should have at most one first action"
